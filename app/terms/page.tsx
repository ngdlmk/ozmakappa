          ...
          <div className="space-y-8 text-gray-800 dark:text-gray-200">
            <section>
              ...
              <p className="leading-relaxed">
                These Terms of Use apply to you, our customer (referred to in these Terms of Use as you, your). By accessing or using our App (the Lebara Travel App) or the Service, you agree to comply with these Terms of Use.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                You need a compatible device that supports eSIM and you are responsible for ensuring your device is compatible.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 mb-4 ml-4">
                <li>Coverage area (e.g. Europe).</li>
                <li>Data allowance (e.g. 5GB).</li>
                <li>Validity period (e.g. 7 days).</li>
                <li>Price.</li>
              </ul>
              <p className="leading-relaxed mb-4">
                You are responsible for selecting a data plan that suits your needs.
              </p>
              <p className="leading-relaxed mb-4">
                Upon successful purchase, your eSIM and data plan will be delivered electronically within the Lebara Travel App. Installation and activation instructions will be provided at the time of purchase and you are responsible for following those instructions.
              </p>
              <p className="leading-relaxed mb-4">
                An eSIM will remain installed on your device after your data plan has been used up or has expired. Further data plans may be purchased for that eSIM.
              </p>
              <p className="leading-relaxed">
                Each eSIM is for single-device use and cannot be transferred.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 mb-4 ml-4">
                <li>Misuse the Travel eService or use it for illegal, fraudulent, prohibited or harmful activities, or otherwise use the Service in breach of applicable law.</li>
                <li>Resell or redistribute the Service.</li>
                <li>Exceed reasonable usage limits (where a data plan has an unlimited allowance).</li>
              </ul>
              <p className="leading-relaxed">
                You are responsible for all activity conducted through the eSIM that you purchased.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed mb-4">
                Data plans are prepaid and charges are payable at the time of purchase.
              </p>
              <p className="leading-relaxed">
                All prices are shown in GBP (£) on the Lebara Travel App and include VAT (or other equivalent sales taxes), unless otherwise stated.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                If the Service that's provided doesn't comply with these Terms of Use, or your eSIM or data plan cannot be installed or activated because of a technical issue not caused by your device or your actions, you may be entitled to a replacement or full or partial refund. Please contact us using the contact details set out at the end of these Terms of Use to report any issues or request a refund.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed mb-4">
                We collect and process personal data in accordance with applicable data protection laws. Details about the collection of personal data in connection with the use of the Service can be found in Lebara's Privacy Notice which can be accessed <a href="/privacy" className="text-[#242fe3] underline">here</a>.
              </p>
              <p className="leading-relaxed mb-4">
              ...
              <p className="leading-relaxed mb-4">
                You have rights with regard to your personal data and these are detailed in Lebara's Privacy Notice. Should you have any requests in relation to those rights, Lebara can be contacted as follows:
              </p>
              <ul className="list-disc list-inside space-y-2 mb-4 ml-4">
                <li>by email to <a href="mailto:dpo@lebara.com" className="text-[#242fe3] underline">dpo@lebara.com</a></li>
                <li>in writing to Lebara: FAO the DPO, 5th Floor, Broadwalk House, 5 Appold Street, London EC2A 2DA, United Kingdom</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 mb-4 ml-4">
                ...
                <li>We're not responsible for issues arising from device incompatibility, the incorrect installation of an eSIM or from your actions.</li>
                <li>Coverage and speeds may vary depending on our roaming agreements and local network conditions – we do not guarantee connection availability, network quality, capacity or availability in countries that are not supported.</li>
                <li>The Service is provided on an 'as is' basis – we do not guarantee uninterrupted or error-free service (the Service is experimental and may contain bugs or limitations).</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 mb-4 ml-4">
                ...
                <li>We are not liable for any indirect, special, incidental or consequential damages arising from your use of, or inability to use, the Service.</li>
                <li>Our total liability to you shall not exceed the amount you paid for the affected Service.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed mb-4">
                We reserve the right to discontinue the Service and the sale of eSIMs and data plans at any time for our own operational reasons. The Service may be provided for a limited time only.
              </p>
              <p className="leading-relaxed">
                You may stop using the Service at any time, but no refunds will be issued.
              </p>
            </section>
